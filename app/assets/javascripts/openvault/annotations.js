   $(function() {
     ...
     if($('div.tools').length > 0) {
       ...
       // NOTE: ajaxyDialog may be broken, it's saying $.widget is undefined
       // when trying to use jquery's widget factory. Need to figure out if this has changed or not.
